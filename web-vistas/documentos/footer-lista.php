<div class="flex flex-wrap items-center justify-center mx-5 h-16">
    ...
    <div class="grow flex flex-wrap justify-center mt-2">
        <a href="#" onclick="listadoOtrosDocumentosPagina(1)" class="rounded-full mx-1 <?php echo ($paginaActual != 1)? 'bg-white text-blendi-200' : 'bg-blendi-200 text-white'; ?> p-2 h-10 w-10 leading-6 text-center">1</a>
        <?php
        if ($cantidadPaginas > 1) {
            ...
            for ($paginaBucleParte1 = $paginaBucleParte1Inicial; $paginaBucleParte1 <= $paginaBucleParte1Total; $paginaBucleParte1++) {
                ?>
                <a href="#" onclick="listadoOtrosDocumentosPagina(<?php echo $paginaBucleParte1; ?>)" class="rounded-full mx-1 <?php echo ($paginaActual != $paginaBucleParte1)? 'bg-white text-blendi-200' : 'bg-blendi-200 text-white'; ?> p-2 h-10 w-10 leading-6 text-center"><?php echo $paginaBucleParte1; ?></a>
                <?php
            }
            if ($paginaBucleParte2Total) {
                ...
                for ($paginaBucleParte2 = $paginaBucleParte2Inicial; $paginaBucleParte2 <= $paginaBucleParte2Total; $paginaBucleParte2++) {
                    ?>
                    <a href="#" onclick="listadoOtrosDocumentosPagina(<?php echo $paginaBucleParte2; ?>)" class="rounded-full mx-1 <?php echo ($paginaActual != $paginaBucleParte2)? 'bg-white text-blendi-200' : 'bg-blendi-200 text-white'; ?> p-2 h-10 w-10 leading-6 text-center"><?php echo $paginaBucleParte2; ?></a>
                    <?php
                }
            }
            ...
            ?>
            <a href="#" onclick="listadoOtrosDocumentosPagina(<?php echo $cantidadPaginas; ?>)" class="rounded-full mx-1 <?php echo ($paginaActual != $cantidadPaginas)? 'bg-white text-blendi-200' : 'bg-blendi-200 text-white'; ?> p-2 h-10 w-10 leading-6 text-center"><?php echo $cantidadPaginas; ?></a>
            <?php
        }
        ?>
    </div>
    ...
    <div id="dropdownResultadosMenu" class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow">
        <div class="h-11 flex items-center"><a href="#" onclick="listadoOtrosDocumentosMostrarResultados(10)" class="p-3">10 ítems</a></div>
        <div class="h-11 flex items-center"><a href="#" onclick="listadoOtrosDocumentosMostrarResultados(15)" class="p-3">15 ítems</a></div>
        <div class="h-11 flex items-center"><a href="#" onclick="listadoOtrosDocumentosMostrarResultados(30)" class="p-3">30 ítems</a></div>
    </div>
    <script type="text/javascript">
        loadDropdownResultadosOtrosDocumentosListado();
    </script>
</div>
