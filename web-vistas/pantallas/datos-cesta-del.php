...
<div class="flex bg-gray-25 dark:bg-graydark-650">
    <a href="#" class="bg-gray-25 dark:bg-graydark-650 w-full flex items-center justify-center font-medium text-sm text-center p-3 text-blendi-600 font-bold hover:text-blendidark-50" type="button" onclick="modalDel.show()">
...
<div id="modal-del" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 w-full md:inset-0 h-modal md:h-full">
    <div class="relative p-4 w-full max-w-2xl h-full md:h-auto">
        ...
        <div class="relative bg-white rounded-lg shadow">
            ...
            <div class="flex justify-between items-start p-4 rounded-t border-b dark:border-gray-600">
                ...
                <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white" onclick="modalDel.hide()">
            ...
            <div class="p-6 space-y-6 modal-body overflow-y-auto">
                <div class="flex items-center p-3 bg-gray-50">
                    <button class="button-documento grow" onclick="collapseMenu('capa-datos-cabecera-del'); return false;">
                        Datos entrega domicilio
                    </button>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 cursor-pointer" id="capa-datos-cabecera-del-show" onclick="collapseMenu('capa-datos-cabecera-del'); return false;">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v6m3-3H9m12 0a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 cursor-pointer hidden" id="capa-datos-cabecera-del-hidden" onclick="collapseMenu('capa-datos-cabecera-del'); return false;">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M15 12H9m12 0a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                    <div class="w-4 ml-2">&nbsp;</div>
                </div>
                <div class="<?php echo $class; ?> mt-4" id="capa-datos-cabecera-del">
                    <div class="grid grid-cols-2 sm:grid-cols-3 gap-4">
                        ...
                        <div class="w-full" id="capa-nombre-del">
                            <div class="row text-left input-cesta">
                        ...
                        <div class="w-full" id="capa-direccion-del">
                            <div class="row text-left input-cesta">
                        ...
                        <div class="w-full" id="capa-numero-del">
                            <div class="row text-left input-cesta">
                                <strong>Número:</strong>
                            </div>
                            <div class="row text-left">
                        ...
                        <div class="w-full" id="capa-escalera-del">
                            <div class="row text-left input-cesta">
                        ...
                        <div class="w-full" id="capa-piso-del">
                            <div class="row text-left input-cesta">
                                <strong>Piso:</strong>
                            </div>
                            <div class="row text-left">
                        ...
                        <div class="w-full" id="capa-puerta-del">
                            <div class="row text-left input-cesta">
                        ...
                        <div class="w-full" id="capa-localidad-del">
                            <div class="row text-left input-cesta">
                        ...
                        <div class="w-full" id="capa-codigo-postal-del">
                            <div class="row text-left input-cesta">
                        ...
                        <div class="w-full">
                            ...
                            <div class="row text-left" id="capa-movil-del">
                                <input type="text" class="sin-borde input-cesta w-full" name="mobil_documento" id="mobil_documento" value="<?php echo $mobil; ?>" onkeydown="return controlSpacios(event);" onkeyup="return buscarDatosDel(9);" />
                            </div>
                        </div>
                        <div class="w-full" id="capa-fecha-entrega-del">
                            <div class="row text-left input-cesta">
                                <strong>Fecha entrega:</strong>
                            </div>
                            <div class="row text-left">
                                <input type="date" class="sin-borde input-cesta w-full" name="fecha_entrega_documento" id="fecha_entrega_documento" value="<?php echo $fecha_entrega; ?>" />
                            </div>
                        </div>
                        <div class="w-full" id="capa-hora-entrega-del">
                            <div class="row text-left input-cesta">
                                <strong>Hora entrega:</strong>
                            </div>
                            <div class="row text-left">
                                <input type="time" class="sin-borde input-cesta w-full" name="hora_entrega_documento" id="hora_entrega_documento" value="<?php echo $hora_entrega; ?>" />
                            </div>
                        </div>
                    </div>
                    <div class="grid-2-cesta grid grid-cols-2 gap-4 mt-5">
                        ...
                        <div class="row">
                            <button class="button-documento" onclick="identificar('del');">
                                Guardar
                            </button>
                        </div>
                    </div>
...
<script type="text/javascript">
    (function() {
        window.modalDel = new Modal(document.getElementById('modal-del'));
    })();
</script>
