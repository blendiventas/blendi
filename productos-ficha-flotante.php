    ...
    <div class="<?php echo $clase_crad_grid_productos; ?> bg-white rounded p-2 mx-1 mb-2 overflow-y-hidden font-bold text-sm drop-shadow-md">
        ...
        if(!empty($url_externa[$key])) {
            if (($tipo_producto_categorias[$key] == 0 || $tipo_producto_categorias[$key] == 1) && $numero_de_lotes_activos[$key] <= 0 && $tiene_enlazados[$key] <= 0 && $tiene_multiples[$key] <= 0 && $tiene_packs[$key] <= 0) {
                ...
                <?php echo $id_producto_mostrar[$key]; ?>,
                    ...
                    '<?php echo $coste[$key]; ?>',
                    '<?php echo $grupos_productos_relacionados_grupos[array_search($selected_option_group, $id_productos_relacionados_grupos)]; ?>',
                ...
                ?>
                <a href="<?php echo $host_url.$descripcion_categoria_producto[$key]."/".$url_externa[$key]; ?>" target="_self">
                <?php
            }
        }else {
            if (($tipo_producto_categorias[$key] == 0 || $tipo_producto_categorias[$key] == 1) && $numero_de_lotes_activos[$key] <= 0 && $tiene_enlazados[$key] <= 0 && $tiene_multiples[$key] <= 0 && $tiene_packs[$key] <= 0) {
                ...
                ?>
                <a href="<?php echo $host_url.$descripcion_categoria_producto[$key]."/".$descripcion_url_mostrar[$key]; ?>" target="_self">
                <?php
            }
        }
        ?>
        <div class="flex items-center card-producto">
            ...
            if($mostrar_imagen == false) {
                ...
                <div class="grow w-full">
                    ...
                    if($interface == "tpv") {
                        ...
                        <div class="vertical-center-div">
                            <div class="text-left card-text card-inicio-titulo">
                        ...
                        <div class="text-productos">
                            <?php echo $descripcion_larga[$key]; ?>
                        </div>
                        <?php
                ...
                ?>
                <div>
                    <img src="<?php echo $ruta_imagen; ?>" class="img-productos h-150p"
                ...
                <div class="grow w-full">
                    ...
                    if($interface == "tpv") {
                        ...
                        ?>
                        <div class="text-left card-text card-inicio-titulo h-40">
                            <?php echo $descripcion[$key]; ?>
                        </div>
                        <?php
                        require("web-vistas/producto/productos-card-body.php");
