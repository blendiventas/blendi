...
// VAPID appPublic key
const strAppPublicKey  = 'BM_wCBPfTZh5GVtw_MgFDFit-0H5iv5VYgINB-v0aZBdP7km2Yotuttdiy0f7YIOgSOLiBv_vgvEQQCPiSZRYTw';
// URL to save subscription on server via Fetch API
const strSubscriberURL = '/PNSubscriber.php';
// default Notification Title if not pushed by server
const strDefTitle      = 'Blendi';
// default Notification Icon if not pushed by server
const strDefIcon       = '/images/logo_cuadrado_120x120.jpg';
...
let ocultarNotificaciones = null;
/**
            ...
            if (self.cookieStore !== undefined) {
                ...
                self.cookieStore
                    ...
                    .then(
                        ...
                        (reason) => {
                            console.error("Fallo en el envío de la cookie: ", reason);
                        }
                    );
            }
        }
