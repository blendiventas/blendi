<input type="hidden" name="apartado" id="apartado" value="complementarios" />


<h2>
    Añadir nuevo embalaje al producto <?php echo $descripcion_productos; ?>
</h2>
...
<div class="grid grid-cols-12 items-center h-10 bg-gray-50 dark:text-white mt-6">
    ...
    <div class="px-3 col-span-4">
        Cantidad y sumar el precio al PVP
    </div>
...
<div class="overflow-y-auto bg-white">
    <?php
    $select_sys = "listado-filtrado-productos-embalajes";
    require($_SERVER['DOCUMENT_ROOT']."/admin/productos/gestion/datos-select-php.php");

    require($_SERVER['DOCUMENT_ROOT']."/admin/productos/componentes/form-select-productos-embalajes.php");
    ?>
</div>
<script type="text/javascript">
