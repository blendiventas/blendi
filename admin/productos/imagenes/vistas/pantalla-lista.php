...
if(!empty($descripcion_productos)) {
    ?>
    <h4><?php echo $descripcion_productos; ?></h4>
    <?php
}
?>
...
if(isset($matriz_id_productos_images)) {
    foreach ($matriz_id_productos_images as $key_productos_images => $valor_productos_images) {
        ...
        <input type="hidden" name="id_productos_images" id="id_productos_images" value="<?php echo $valor_productos_images; ?>" />
        ...
        <input type="hidden" name="id_ancla" id="id_ancla" value="<?php echo $contador_lineas; ?>" />

        <div class="grid grid-cols-1 sm:grid-cols-3 mt-3 items-center space-x-3" id="linea_<?php echo $contador_lineas; ?>">
            <div class="text-left">
            ...
            <div id="capa_img_activo_<?php echo $valor_productos_images; ?>">
                <?php
