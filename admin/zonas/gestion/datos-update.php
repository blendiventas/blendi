...
$id_libradores_zonas = filter_input(INPUT_POST, 'id_libradores_zonas', FILTER_SANITIZE_NUMBER_INT);
$zona_libradores_zonas = filter_input(INPUT_POST, 'zona_libradores_zonas', FILTER_SANITIZE_STRING);

$ajax_sys = true;

require($_SERVER['DOCUMENT_ROOT']."/assets/conn/ddbb.php");

require($_SERVER['DOCUMENT_ROOT']."/admin/zonas/gestion/datos-update-php.php");