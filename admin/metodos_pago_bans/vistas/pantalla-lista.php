<div class="grid grid-cols-12 items-center h-10 bg-gray-50 sm:mx-5 mt-3 dark:text-white">
    <div class="px-3 col-span-9 sm:col-span-8">
        Correo
    </div>
    <div class="text-center sm:col-span-2 px-3">
        Metodo de pago
    </div>
...
if(isset($matriz_id_metodos_pago_bans)) {
    ?>
    <div id="capa_listado_resultados" class="overflow-y-auto bg-white sm:mx-5">
        <?php
        foreach ($matriz_id_metodos_pago_bans as $key => $valor) {
            ?>
            <div class="grid grid-cols-12 items-center h-14 bg-white border-2 border-gray-50" id="linea_<?php echo $valor; ?>">
                <div class="px-3 col-span-9 sm:col-span-8"><?php echo $matriz_correo_metodos_pago_bans[$key]; ?></div>
                <div class="text-center sm:col-span-2 px-3"><?php echo $matriz_descripcion_metodos_pago_bans[$key]; ?></div>
    ...
    <?php
    unset($matriz_id_metodos_pago_bans);
    unset($matriz_id_metodo_pago_metodos_pago_bans);
    unset($matriz_descripcion_metodos_pago_bans);
    unset($matriz_correo_metodos_pago_bans);
    ...
    <div class="flex items-center justify-center h-10 bg-white mx-5">
        <div class="text-center grow px-3">
            No existen bans en métodos de pago definidos.
        </div>
    </div>
    <?php
}
