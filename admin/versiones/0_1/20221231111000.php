<?php
$result = $conn->query("CREATE TABLE `compras_2023` (
`Proveedor` VARCHAR(182) NOT NULL COLLATE 'utf8_spanish_ci',
`Razon Comercial` VARCHAR(75) NOT NULL COLLATE 'utf8_spanish_ci',
`articulos` VARCHAR(250) NOT NULL COLLATE 'utf8_spanish_ci',
`Unidad` VARCHAR(5) NOT NULL COLLATE 'utf8_spanish_ci',
`Coste` DOUBLE(15,5) NOT NULL
) ENGINE=MyISAM;");

$result = $conn->query("CREATE TABLE IF NOT EXISTS `documentos_2023_1` (
...
$result = $conn->query("CREATE TABLE IF NOT EXISTS `documentos_2023_2` (
`id` int(11) NOT NULL AUTO_INCREMENT,
...
$result = $conn->query("CREATE TABLE IF NOT EXISTS `documentos_2023_iva` (
`id` int(11) NOT NULL AUTO_INCREMENT,
...
$result = $conn->query("CREATE TABLE IF NOT EXISTS `documentos_2023_libradores` (
...
$result = $conn->query("CREATE TABLE IF NOT EXISTS `documentos_2023_libradores_envio` (
`id` int(11) unsigned NOT NULL AUTO_INCREMENT,
`id_documentos_1` int(11) DEFAULT NULL,
`fecha_documento` date DEFAULT NULL,
...
$result = $conn->query("CREATE TABLE IF NOT EXISTS `documentos_2023_observaciones` (
`id` int(11) NOT NULL AUTO_INCREMENT,
`id_documentos_1` int(11) NOT NULL,
...
$result = $conn->query("CREATE TABLE IF NOT EXISTS `documentos_2023_productos_costes` (
`id` int(11) NOT NULL AUTO_INCREMENT,
`id_documentos_2` int(11) NOT NULL,
...
$result = $conn->query("CREATE TABLE IF NOT EXISTS `documentos_2023_productos_relacionados` (
`id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
$result = $conn->query("CREATE TABLE IF NOT EXISTS `documentos_2023_productos_relacionados_combo` (
`id` int(11) unsigned NOT NULL AUTO_INCREMENT,
`id_documentos_2` int(11) unsigned NOT NULL DEFAULT '0',
`id_productos_detalles_enlazado` int(11) unsigned NOT NULL DEFAULT '0',
`id_productos_detalles_multiples` int(11) unsigned NOT NULL DEFAULT '0',
...
$result = $conn->query("CREATE TABLE IF NOT EXISTS `documentos_2023_productos_relacionados_elaborados` (
`id` int(11) unsigned NOT NULL AUTO_INCREMENT,
`id_documentos_2` int(11) unsigned NOT NULL DEFAULT '0',
`id_productos_detalles_enlazado` int(11) unsigned NOT NULL DEFAULT '0',
`id_productos_detalles_multiples` int(11) unsigned NOT NULL DEFAULT '0',
...
$result = $conn->query("CREATE TABLE IF NOT EXISTS `documentos_2023_productos_sku_stock` (
`id` int(11) NOT NULL AUTO_INCREMENT,
`id_producto` int(11) NOT NULL DEFAULT '0',
...
$result = $conn->query("CREATE TABLE IF NOT EXISTS `documentos_2023_recibos` (
`id` int(11) NOT NULL AUTO_INCREMENT,
...
$result = $conn->query("SELECT * FROM documentos_numeraciones WHERE ejercicio='2022';");
...
$result = $conn->query("DROP TABLE IF EXISTS `compras_2023`;");
$result = $conn->query("CREATE ALGORITHM=UNDEFINED SQL SECURITY DEFINER VIEW `compras_2023` AS select concat(`dl`.`nombre`,' ',`dl`.`apellido_1`,' ',`dl`.`apellido_2`) AS `Proveedor`,`dl`.`razon_comercial` AS `Razon Comercial`,`d2`.`descripcion_producto` AS `articulos`,`d2`.`unidad` AS `Unidad`,`d2`.`coste` AS `Coste` from ((`documentos_2023_1` `d1` join `documentos_2023_2` `d2` on((`d1`.`id` = `d2`.`id_documentos_1`))) join `documentos_2023_libradores` `dl` on((`dl`.`id_documentos_1` = `d1`.`id`))) where (`d1`.`tipo_librador` = 'pro');");
